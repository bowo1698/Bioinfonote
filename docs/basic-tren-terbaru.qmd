...
![](https://neurosys.com/wp-content/webp-express/webp-images/uploads/2023/05/aquaculture-header.png.webp){.content-image .article-hero-image fig-alt="Teknologi digital dalam akuakultur"}
...
![**Aplikasi genomik dalam akuakultur.** Penerapan teknologi genomik dalam akuakultur mencakup identifikasi spesies, studi perilaku, deteksi penyakit, analisis filogenetik, studi asosiasi genom menyeluruh (GWAS), seleksi berbasis penanda (MAS), dan modifikasi epigenetik. Pendekatan ini mendukung pemahaman mendalam tentang genetika ikan dan peningkatan program pemuliaan. *Sumber gambar:* [Khatei et al. 2025](https://link.springer.com/chapter/10.1007/978-981-97-8553-7_11)](images/genomic-application.png){.content-image fig-alt="Aplikasi genomik dalam akuakultur" width="85%"}
...
![**Alur genomic selection.** *Genomic selection* dimulai dari *genotyping* dan *phenotyping* populasi referensi, dilanjutkan dengan pemodelan prediksi nilai pemuliaan genomik (GEBV) yang digunakan untuk menyeleksi induk unggul dari populasi kandidat yang belum diketahui fenotipenya. *Sumber gambar:* [Song et al. 2022](https://doi.org/10.1111/raq.12716)](images/gs.png){.content-image fig-alt="Alur genomic selection" width="85%"}
...
![**Produksi induk pengganti salmon masu dan generasi berikutnya dari rainbow trout melalui transplantasi sel punca germinal.** Sel punca spermatogonia dari *rainbow trout* jantan ditransplantasikan ke dalam rongga peritoneum larva salmon masu triploid mandul yang baru menetas. Sel spermatogonia trout tersebut kemudian berhasil berkolonisasi di gonad ikan penerima, yang selanjutnya mampu menghasilkan sel telur atau sperma yang berasal dari donor, tergantung pada jenis kelamin ikan penerima. *Sumber gambar:* [Yoshizaki & Yazawa. 2019](https://doi.org/10.1007/s12562-019-01299-y)](images/sb.png){.content-image fig-alt="Produksi surrogate broodstock" width="85%"}
...
![**Studi OMICS.** *Sumber gambar:* [Gen-Fish](https://gen-fish.ca/intro-to-omics/)](https://i0.wp.com/gen-fish.ca/wp-content/uploads/2024/04/Omics-Infographic.png?fit=4000%2C2000&ssl=1){.content-image fig-alt="Infografik studi OMICS" width="85%"}
