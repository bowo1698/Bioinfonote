...
![](https://wallpapers.com/images/hd/linux-pictures-g8nflkx3vjw6v0xq.jpg){.content-image .article-hero-image fig-alt="Linux di dalam Windows"}
...
![](images/Periodic%20Table%20of%20Distros.png){.content-image fig-alt="Tabel periodik distribusi Linux" width="85%"}
...
2.  Untuk melihat distro Linux yang tersedia, cukup jalankan perintah
    ...
    ![](images/list-distro.png){.content-image fig-alt="Daftar distribusi WSL" width="90%"}
...
6.  Perintah di atas akan memuat permintaan untuk mengatur Linux, seperti nama user, password, dll. Maka isi semua permintaan yang diminta.
    ...
    ![WSL Set](images/wsl-linux-set-01.png){width="90%"}
...
![](images/sudo-su.png){.content-image fig-alt="Contoh penggunaan superuser" width="90%"}
...
3.  Import file distro yang sudah dicadangkan sebelumnya (`ubuntu.tar`) dengan perintah berikut:
    ...
    ![](images/wsl-import-success.png){.content-image fig-alt="Proses impor WSL berhasil" width="90%"}
...
4.  Atur *mounting* Linux dengan cara menjalankan perintah berikut:
    ...
    ![](images/wsl-mounting-set.png){.content-image fig-alt="Pengaturan mounting WSL" width="90%"}
...
5.  Nonaktifkan otomatis mount Linux ke drive `C:/` dengan cara menjalankan perintah berikut:
    ...
    ![](images/wsl-nano-set.png){.content-image fig-alt="Pengaturan WSL menggunakan Nano" width="90%"}
