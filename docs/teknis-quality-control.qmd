...
![](images/fastqc.png){.content-image fig-alt="Contoh hasil FastQC" width="90%"}
...
![](images/multiqc.png){.content-image fig-alt="Status pemeriksaan MultiQC" width="90%"}

## Kenapa kualitas data sekuensing bisa buruk? {#kenapa-kualitas-data-sekuensing-bisa-jelek}
...
![](images/qc-problem.png){.content-image fig-alt="Masalah yang terdeteksi pada quality control" width="90%"}
...
Untuk automatisasi proses trimming dengan FASTP serta menangani data yang mungkin banyak, saya sudah menyiapkan code bash yang bisa digunakan untuk menangani data *paired-end* apapun selama memiliki format file \*\_R1/R2.fastq.gz. Anda bisa [mengunduh kode Bash di sini](/code/process_paired_fastq.sh){download="process_paired_fastq.sh"} dan menjalankan perintah sebagai berikut:
...
{{< video https://www.youtube.com/embed/UXbhQsSyCr8 >}}
