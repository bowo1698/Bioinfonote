...
![](https://media.licdn.com/dms/image/v2/C4E12AQFPvha4VBvb-Q/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1535910192895?e=2147483647&v=beta&t=8icwEGmeRprmA7ALE2Dp6iCaIShCpL8X3WpLrL4MFgQ){.content-image .article-hero-image fig-alt="Ilustrasi sistem operasi Linux"}
...
## Linux file system: Siapa tinggal di mana? {#linux-file-system-siapa-tinggal-di-mana}
...
![](images/linux-fhs.webp){.content-image fig-alt="Hierarki filesystem Linux" width="90%"}
