...
![](https://collections.museumsvictoria.com.au/content/media/12/397512-large.jpg){.content-image .article-hero-image fig-alt="Gurita cincin biru"}
...
![](images/fastq-file-format.png){.content-image fig-alt="Contoh format file FASTQ" width="90%"}
...
![](images/chmod.png){.content-image fig-alt="Ilustrasi izin akses chmod" width="90%"}
